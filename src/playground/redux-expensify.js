...
const expOne = store.dispatch(addExpense({description: 'Rent', amount: 50000, createdAt: 100}));
const expTwo = store.dispatch(addExpense({description: 'Coffee', amount: 300, createdAt: 200}));
...
store.dispatch(setText({text: 'coffee'}));
